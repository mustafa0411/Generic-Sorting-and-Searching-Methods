...
public class Sort {
	 ...
	 * 
	 * @param input is the list of the elements, 
	...
	public static <E extends Comparable<E>> void insertionSort(List<E> input, int sortOrder)
		...
		for (int j = 1; j < input.size(); j++) {
			...
			//while loop for sorting each of the elements in the list in either ascending or descending order
	 ...
	 * @param input is the list of the elements, 
	 * sortOrder determines ascending or descending order
	 * start is the begining of the list and end is the end of the list
	 * @return N/A
	 */
	public static <E extends Comparable<E>> void doQuickSort(List<E> input, int start, int end, int sortOrder)
		...
		for (int i = start + 1; i <= end; i++) {
			...
			//checks the if the pivote is greater then 0 in either descending or ascending order
			if (compare > 0 && sortOrder == ASCENDING || compare < 0 && sortOrder == DESCENDING) {
	...
	/**
	* swap method that is used to swap the elements in 
	* the list so that they can be sorted
	* 
	* @param input is the list of elements
	* a and b are the values that are bieng swapped
	* @return N/A
	*/
